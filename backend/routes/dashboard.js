...
async function obterDashboard(usuarioAtual) {
  ...
  // Correção do bug: contar DIRETO das solicitações existentes, em vez de depender
  // da lista atual de tipos cadastrados. Isso evita divergência quando um tipo é
  // renomeado ou excluído no cadastro depois de já existirem solicitações com ele.
  ...
  // Mesma correção aplicada em "por local" (tinha o mesmo problema latente)
